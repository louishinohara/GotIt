...
class GCloud:
    def __init__(self, RATE, CHUNK, language_code):
    ...
    def testLocalAudio(self):
        # Test audio file somewhere on the internet
        ...
        print("Getting transcript from local audio file")
    ...
    def getStreamedTranscription(self, zoom):
        mic =  MicrophoneStream(self.rate, self.chunk, zoom)
        with mic as stream:
...
class MicrophoneStream(object):
    ...
    def __init__(self, rate, chunk, zoom):
        self._rate = rate
        self._chunk = chunk
        self.zoom = zoom
    ...
    # This line will retrive responses from server and print them
